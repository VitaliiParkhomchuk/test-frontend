  ...
  return (
    <>
      <button
        ...
        className={clsx(
          className,
          "spec-card grad-border group relative flex w-full cursor-pointer flex-col overflow-hidden rounded-[20px] bg-white/[0.03] p-5 text-left backdrop-blur-xl sm:p-6"
        )}
      >
        <div
          aria-hidden
        ...
        <div className="relative flex items-center gap-4">
          ...
          <div className="min-w-0 flex-1">
            ...
            <h3
              className="font-display mt-0.5 truncate font-bold text-white"
        ...
        <p className="line-clamp-2 text-[13px] text-white/60">
        ...
        <div className="mt-4 flex flex-wrap gap-1.5">
          ...
          {alumni.degree && (
            <span className="font-display rounded-full border border-white/10 bg-white/[0.04] px-3 py-1 text-[10px] font-bold uppercase tracking-[0.04em] text-white/70">
              {alumni.degree}
            </span>
          )}
        </div>

        <div className="mt-5 flex items-center justify-between text-[12px] font-semibold text-white/55 transition-colors group-hover:text-white">
          Дізнатись більше
