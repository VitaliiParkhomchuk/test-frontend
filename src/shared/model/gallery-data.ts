...
export const GALLERY_EVENTS: GalleryEvent[] = [
  {
    ...
    year: 2024,
    date: "22 червня 2024",
    description: "Урочиста церемонія вручення дипломів випускникам ННІКІТІ 2024 року. Цього року інститут випустив понад 180 фахівців у галузі інформаційних технологій.",
    coverSeed: 10,
  },
  {
    id: "open-day-2024",
    ...
    year: 2024,
    date: "15 квітня 2024",
    description: "Щорічний День відкритих дверей ННІКІТІ зібрав понад 400 абітурієнтів та їхніх батьків. Студенти та викладачі провели екскурсії лабораторіями і майстер-класи.",
    coverSeed: 17,
  },
  {
    id: "marathon-2023",
  ...
  },
  {
    ...
    description: "Всеукраїнська студентська олімпіада з програмування. Команда ННІКІТІ здобула друге місце у командному заліку серед 32 університетів.",
    coverSeed: 28,
  },
  {
    id: "conference-2022",
  ...
  },
  {
    ...
    year: 2022,
    date: "3 травня 2022",
    description: "Щорічний студентський фестиваль талантів ННІКІТІ. Виступи, конкурси, виставки студентських проєктів та творчі майстерні.",
    coverSeed: 41,
  },
];
...
export const ALL_PHOTOS: Photo[] = [
  ...
  { id: 22, src: p(31, true),  alt: "Олімпіада 2023 — команда ННІКІТІ",                      year: 2023, eventId: "olympiad-2023",  wide: true  },
  // General 2023
  { id: 23, src: p(32, true),  alt: "Студентське життя ННІКІТІ 2023",                        year: 2023, wide: true  },
  ...
  { id: 39, src: p(48, true),  alt: "Студентська рада ННІКІТІ 2021",                         year: 2021, wide: true  },
