  ...
  return (
    <button
      className={clsx(
        ...
        color === "black" &&
          !isHovered &&
          "bg-black text-primary outline-white before:bg-white hover:text-black hover:outline-black",
        color === "white" &&
          !isHovered &&
          "bg-white text-black outline-black before:bg-black hover:text-primary hover:outline-white",
        size === "s" && "text-sm",
        size === "m" && "text-base",
        ...
        !isHovered && color === "black" && "text-primary outline-white",
        isHovered && color === "white" && "bg-white text-primary outline-white before:bg-black",
