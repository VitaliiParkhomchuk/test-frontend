      ...
      <Stagger className="container-v2 relative z-[1] flex flex-col items-center text-center" stagger={0.1} delay={0.35} inView={false}>
        <StaggerItem mode="scale">
          <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-violet-500/25 bg-violet-500/10 py-1.5 pl-2 pr-4 backdrop-blur-md">
            ...
            <span className="text-[12px] text-white/70">випускників ННКІТІ</span>
          </div>
        </StaggerItem>
        ...
        <StaggerItem mode="scale">
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="sheen mt-8 inline-flex items-center gap-2 rounded-[14px] bg-gradient-to-r from-violet-500 to-blue-500 px-7 py-3.5 text-[14px] font-semibold text-white shadow-[0_4px_16px_rgba(166,132,255,0.3)] transition-shadow duration-200 hover:shadow-[0_8px_32px_rgba(166,132,255,0.55)] sm:text-[15px]"
          >
